...
export const privacyContent: Record<Locale, PrivacyContent> = {
  ...
  ka: {
    ...
    noteText:
      "ვებსაიტი ზოგად ინფორმაციას იძლევა. ვიზიტი მხოლოდ კლინიკის დადასტურების შემდეგ ითვლება დაგეგმილად, ხოლო მკურნალობის შესახებ გადაწყვეტილება კლინიკაში ჩატარებული გამოკვლევის საფუძველზე მიიღება.",
  },
};
