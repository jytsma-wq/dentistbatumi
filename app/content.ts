...
export const siteCopy: Record<Locale, SiteCopy> = {
  ...
  nl: {
    ...
    hero: {
      ...
      title: "Vakkundige tandheelkunde.",
    ...
    faq: {
      ...
      items: [
        ...
        { question: "Is een online beoordeling al een diagnose?", answer: "Nee. De online beoordeling helpt om de opties en planning voor te bereiden. De diagnose, het definitieve plan en de prijs volgen na onderzoek in de kliniek." },
        { question: "Moet ik gebruikmaken van georganiseerde reis- of nazorgdiensten?", answer: "Nee. U houdt zelf de regie over uw reis en verblijf. De kliniek verstrekt behandeldata, praktische informatie en passende nazorgdocumentatie." },
      ],
    },
    pages: {
      treatmentsTitle: "Tandheelkundige behandeling op basis van een goede diagnose.",
      treatmentsLead: "Dagelijkse zorg en complexe rehabilitatie horen thuis in één verantwoord opgesteld klinisch behandelplan.",
      ...
      clinicLead: "U hoort te weten wie uw zorg plant, wie deze uitvoert en hoe u het behandelteam bereikt.",
      clinicPrinciples: [
  ...
  de: {
    ...
    needs: { eyebrow: "Beginnen Sie mit Ihrer Frage", title: "Welches Zahnproblem möchten Sie lösen?", items: ["Schmerzen oder ein dringendes Problem", "Ein oder mehrere fehlende Zähne", "Beschädigte Kronen oder abgenutzte Zähne", "Ein natürliches, sicheres Lächeln", "Kontrolle oder professionelle Reinigung", "Vollständige Gebissrehabilitation"] },
    ...
    faq: { eyebrow: "Gut zu wissen", title: "Häufige Fragen", items: [
      ...
      { question: "Muss ich organisierte Reise- oder Nachsorgedienste in Anspruch nehmen?", answer: "Nein. Sie organisieren Reise und Unterkunft selbst. Die Klinik stellt Behandlungstermine, praktische Informationen und geeignete Nachsorgeunterlagen bereit." },
    ] },
    pages: {
      treatmentsTitle: "Zahnbehandlung auf Grundlage einer guten Diagnose.", treatmentsLead: "Allgemeine Zahnversorgung und komplexe Rehabilitation gehören in einen verantwortungsvoll erstellten klinischen Behandlungsplan.", treatmentDetailEyebrow: "Behandlung bei Marea Dental", forWhom: "Wann kann diese Behandlung helfen?", forWhomText: "Die Eignung wird erst nach Untersuchung und relevanter Bildgebung bestätigt.", planTitle: "Der Behandlungsablauf", planSteps: [...sharedPlanSteps.de], timing: "Zeitplanung", timingNote: "Nach der Beurteilung erhalten Sie einen persönlichen Zeitplan.", priceTitle: "Kosten ohne Überraschungen", priceText: "Nach der Untersuchung erhalten Sie einen schriftlichen Plan mit erwarteten Kosten. Frühere Preisspannen sind unverbindlich.",
  ...
  fr: {
    ...
    actions: { whatsapp: "WhatsApp", appointment: "Demander un rendez-vous", onlineAssessment: "Commencer l’évaluation", call: "Appeler la clinique", quickActions: "Contact rapide", quickQuestion: "Poser une question pratique", chooseMoment: "Choisir votre créneau", learnMore: "En savoir plus", viewAll: "Tout voir" },
    hero: { eyebrow: "Une clinique dentaire · Batoumi", title: "Des soins dentaires de qualité.", emphasis: "Un plan clair. Sans attente inutile.", lead: "Des contrôles et urgences dentaires aux implants, restaurations et réhabilitations complètes — pour les habitants de Batoumi et les patients venant de l’étranger.", localCta: "Demander un rendez-vous", internationalLink: "Voir le parcours de 21 jours", proof: ["Soins locaux & internationaux", "Plan de traitement écrit", "Vous décidez à chaque étape"], imageAlt: "Nature morte éditoriale avec couronne céramique, miroir dentaire et verre marin" },
    routes: {
    ...
    faq: { eyebrow: "À savoir", title: "Questions fréquentes", items: [
      ...
      { question: "Dois-je recourir à des services organisés pour le voyage ou le suivi ?", answer: "Non. Vous restez libre d’organiser votre voyage et votre hébergement. La clinique fournit les dates de traitement, les informations pratiques et les documents de suivi adaptés." },
    ] },
    pages: {
      treatmentsTitle: "Des soins fondés sur un diagnostic sérieux.", treatmentsLead: "Les soins courants et les réhabilitations complexes s’inscrivent dans un même plan de traitement clinique, établi de manière responsable.", treatmentDetailEyebrow: "Traitement chez Marea Dental", forWhom: "Quand ce traitement peut-il aider ?", forWhomText: "L’indication n’est confirmée qu’après examen clinique et imagerie utile.", planTitle: "Le parcours de traitement", planSteps: [...sharedPlanSteps.fr], timing: "Calendrier", timingNote: "Un calendrier personnel est confirmé après l’évaluation.", priceTitle: "Des coûts sans surprise", priceText: "Après l’examen, vous recevez un plan écrit avec les coûts prévus. Toute fourchette préalable reste indicative.",
  ...
  lb: {
    ...
    proof: { eyebrow: "Vertraue muss iwwerpréifbar sinn", title: "Keng anonym Klinik. Keng vague Verspriechen.", items: ["Genannte Behandler mat iwwerpréifbare Qualifikatiounen", "Echt Fäll mat Zoustëmmung a Kontext", "Materialien, Schrëtt a Käschte kloer erkläert", "E kloeren Ënnerscheed tëscht provisorescher an definitiver Versuergung"] },
  ...
  ka: {
    ...
    actions: { whatsapp: "WhatsApp", appointment: "ვიზიტის მოთხოვნა", onlineAssessment: "ონლაინ შეფასების დაწყება", call: "კლინიკაში დარეკვა", quickActions: "სწრაფი კავშირი", quickQuestion: "დასვით პრაქტიკული კითხვა", chooseMoment: "აირჩიეთ სასურველი დრო", learnMore: "გაიგეთ მეტი", viewAll: "ყველაფრის ნახვა" },
    hero: { eyebrow: "ერთი სტომატოლოგიური კლინიკა · ბათუმი", title: "პროფესიული სტომატოლოგია.", emphasis: "მკაფიო გეგმა. ზედმეტი ლოდინის გარეშე.", lead: "შემოწმებიდან და მწვავე ტკივილიდან იმპლანტებამდე, რესტავრაციამდე და სრულ რეაბილიტაციამდე — ბათუმის მცხოვრებლებისა და უცხოეთიდან ჩამომსვლელთათვის.", localCta: "ვიზიტის მოთხოვნა", internationalLink: "21-დღიანი გეგმის ნახვა", proof: ["ადგილობრივი და საერთაშორისო ზრუნვა", "წერილობითი მკურნალობის გეგმა", "ყოველ ნაბიჯზე თქვენ წყვეტთ"], imageAlt: "კერამიკული გვირგვინის, სტომატოლოგიური სარკისა და ზღვის შუშის სარედაქციო ნატურმორტი" },
    routes: {
    ...
    treatments: [
      ...
      { slug: "full-mouth-rehabilitation", number: "05", title: "სრული რეაბილიტაცია", short: "კოორდინირებული გეგმა ცვეთისა და მრავალმხრივი პრობლემების დროს.", audience: "როდესაც ფუნქცია, კომფორტი და იერსახე ერთად საჭიროებენ აღდგენას.", timing: "ბევრი ეტაპი ერთ ვიზიტში ეტევა; შეხორცებამ შეიძლება მოგვიანებით გაგრძელება მოითხოვოს." },
    ...
    pages: {
      ...
      clinicTitle: "ერთი კლინიკა. ერთი პასუხისმგებელი გუნდი.", clinicLead: "უნდა იცოდეთ, ვინ გეგმავს, ვინ მკურნალობს და ვის მიმართავთ კითხვებით.", clinicPrinciples: [{ title: "ჯერ ახსნა", text: "დიაგნოზი, ვარიანტები და შეზღუდვები მკურნალობას წინ უსწრებენ." }, { title: "შენარჩუნება, სადაც შესაძლებელია", text: "ბუნებრივი ქსოვილი არ ეწირება მარკეტინგულ დაპირებას." }, { title: "მკაფიო დოკუმენტაცია", text: "გეგმა, მასალები და შემდგომი რჩევა თქვენს დოკუმენტში შედის." }], teamTitle: "გაიცანით ადამიანები, რომლებიც თქვენს მკურნალობაზე ზრუნავენ", teamText: "გადამოწმებული სახელები, რეგისტრაცია, განათლება, მიმართულებები და ენები გამოქვეყნდება საჯარო გაშვებამდე.", teamRoles: ["იმპლანტოლოგია და ქირურგია", "რესტავრაციული სტომატოლოგია", "პაციენტის კოორდინაცია"], verification: "პროფილი ელოდება კლინიკის დადასტურებას.",
