...
export const medicalUploadCopy: Record<Locale, MedicalUploadCopy> = {
  ...
  ka: {
    ...
    form: {
      ...
      healthConsent:
        "ვადასტურებ, რომ ამ კერძო წინასწარ ვერსიას შეუძლია ფორმაში შეტანილი საკონტაქტო მონაცემების, კონტექსტისა და უვნებელი სატესტო ფაილების დამუშავება. რეალურ პაციენტის მონაცემებს არ ვაგზავნი.",
